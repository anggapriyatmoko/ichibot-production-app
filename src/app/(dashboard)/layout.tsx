        ...
        <SessionProvider session={session}>
            <SidebarProvider>
                ...
                <div className="flex h-dvh bg-background flex-col md:flex-row overflow-hidden">
                    ...
                    <div className="flex-1 flex flex-col min-h-0 relative bg-[#2563eb]">
                        <main
                            className="flex-1 flex flex-col min-h-0 relative overflow-hidden bg-background md:rounded-l-[24px]"
                        >
                            {/* Top gradient accent */}
