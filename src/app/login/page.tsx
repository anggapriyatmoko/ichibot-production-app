...
function LoginContent() {
    ...
    return (
        <div className="min-h-screen flex w-full bg-background overflow-hidden relative">
            {/* Left Side Container */}
            <div className="hidden lg:block w-1/2 bg-background z-10">
                <div className="w-full h-full bg-[#2563eb] relative flex flex-col justify-center items-center text-center p-12 overflow-hidden" style={{ borderTopRightRadius: 'clamp(2rem, 5vw, 4rem)' }}>
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1d4ed8] to-transparent opacity-60 pointer-events-none" />

                    <div className="relative z-10 w-full max-w-lg mx-auto flex flex-col justify-center">
                        <h1 className="text-4xl xl:text-5xl font-black text-white tracking-tight uppercase drop-shadow-md text-left leading-tight whitespace-nowrap">
                            SIGMA ICHIBOT
                        </h1>
                        <p className="text-base xl:text-lg font-medium text-white/90 tracking-wide uppercase text-left max-w-sm mt-4">
            ...
            <div className="flex-1 relative">
                {/* Background blue layer matching the left side's gradient exactly */}
                <div className="hidden lg:block absolute inset-0 bg-[#2563eb] z-0">
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1d4ed8] to-transparent opacity-60 pointer-events-none" />
                </div>

                <div className="w-full h-full bg-background relative z-10 flex flex-col justify-center items-center p-4 lg:p-12" style={{ borderBottomLeftRadius: 'clamp(2rem, 5vw, 4rem)' }}>
                    <div className="w-full max-w-md space-y-8">
                        <div className="text-left space-y-2">
                            {/* Mobile Header (Hidden on Desktop) */}
                            <div className="lg:hidden text-center mb-8 space-y-2">
                                <h1 className="text-3xl font-black bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent tracking-tighter uppercase">
                                    SIGMA ICHIBOT
                                </h1>
                                ...
                                {authType === 'password' ? (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-xs text-center text-muted-foreground hidden md:block">
                                            * Klik keypad atau ketik langsung dengan keyboard
                                        </p>
                                    </div>
                                )}
                            </form>
