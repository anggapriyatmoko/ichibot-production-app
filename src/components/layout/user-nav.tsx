...
export default function UserNav({ user }: UserNavProps) {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="fixed md:absolute left-4 right-4 md:left-auto md:right-0 mt-2 md:w-64 bg-card border border-border rounded-2xl shadow-xl shadow-black/5 animate-in fade-in zoom-in duration-200 z-[110] overflow-hidden">
