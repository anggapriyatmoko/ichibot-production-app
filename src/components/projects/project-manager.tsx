        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center gap-2">
                ...
                {isAdmin && (
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-all font-bold shadow-sm"
                    >
            ...
            {(isAdding || editingProject) && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
                    ...
                    <div className="bg-card border border-border rounded-xl p-4 sm:p-6 w-full max-w-3xl relative animate-in zoom-in-95 duration-200 shadow-2xl max-h-[95vh] overflow-y-auto">
            ...
            <div className="md:hidden space-y-4">
                {filteredProjects.map(project => (
                    <div key={project.id} className="bg-card border border-border rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        {isAdmin && (
                            <div className="flex gap-2 mt-4 pt-4 border-t border-border">
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-2 py-2 text-blue-500 bg-blue-500/5 hover:bg-blue-500/10 rounded-lg transition-colors border border-blue-500/20 text-xs font-bold"
                                >
                                ...
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-2 py-2 text-rose-500 bg-rose-500/5 hover:bg-rose-500/10 rounded-lg transition-colors border border-rose-500/20 text-xs font-bold"
                                >
            ...
            <div className="px-6 py-4 border border-t-0 border-border rounded-b-xl flex items-center justify-between bg-card text-xs text-muted-foreground">
