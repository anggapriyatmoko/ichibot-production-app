...
import { Globe, Key, Loader2, Save, Wifi, WifiOff, Eye, EyeOff, User, Phone, MapPin, Truck, Send, AlertCircle } from 'lucide-react'
import { getAllApiSettings, saveApiSettings, testApiConnection } from '@/app/actions/system-settings'
import { testCreateResi, ResiData } from '@/app/actions/resi'
...
export default function ApiConfigManager() {
    ...
    const [activeTab, setActiveTab] = useState<'connection' | 'sender' | 'test'>('connection')
    ...
    const [testResiResult, setTestResiResult] = useState<{ success: boolean, message: string } | null>(null)
    ...
    const handleTestConnection = async () => {
        ...
        try {
            ...
            setTestResult({ success: false, message: 'Gagal melakukan test koneksi' })
        } finally {
            setIsTesting(false)
        }
    }
    ...
    const handleTestResi = async () => {
        ...
        try {
            ...
            setTestResiResult({ success: false, message: 'Terjadi kesalahan saat test kirim resi' })
        } finally {
        ...
        <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm">
            ...
            <div className="p-4 border-b border-border bg-muted/30 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="font-semibold text-foreground">Integrasi API Resi</h2>
                        <p className="text-xs text-muted-foreground">Konfigurasi koneksi dan data pengirim</p>
                    </div>
                </div>
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-top-2 duration-200">
                        ...
                        <div className="p-4 border border-border rounded-lg bg-card/50">
                            ...
                            <p className="text-xs text-muted-foreground mb-4">
                                Test koneksi sederhana ke endpoint untuk memastikan server dapat dijangkau.
                            </p>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                {testResult && (
                                    <div className={`flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium ${testResult.success
                        ...
                        <div className="p-4 border border-border rounded-lg bg-card/50">
                            ...
                            <p className="text-xs text-muted-foreground mb-4">
                                Mencoba membuat resi dengan data dummy untuk memverifikasi payload dan response.
                            </p>
                            ...
                            <div className="space-y-3">
                                ...
                                {testResiResult && (
                                    <div className={`p-3 rounded-lg text-xs font-mono whitespace-pre-wrap ${testResiResult.success
