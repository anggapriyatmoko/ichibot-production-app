  ...
  return (
    <>
      ...
      {isModalOpen && (
          ...
          footer={
            <div className="flex justify-end gap-3 w-full">
              ...
              <button
                ...
                form="resi-form"
                disabled={saving}
                className="px-6 py-2 bg-blue-500 text-white rounded-xl font-bold shadow-lg shadow-blue-500/20 hover:opacity-90 transition-all disabled:opacity-50 flex items-center gap-2 text-sm"
              >
        ...
        >
          <form id="resi-form" onSubmit={handleSubmit} className="space-y-6">
            {/* Pengirim Section */}
