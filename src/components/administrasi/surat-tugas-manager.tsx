...
export default function SuratTugasManager({
  ...
  return (
    <div className="space-y-6">
          ...
          <TableMobileCard key={st.id}>
            ...
            <TableMobileCardContent>
              <div className="col-span-2 space-y-1">
                <h4 className="font-bold text-sm tracking-tight">{st.title}</h4>
                ...
                <div className="col-span-2 p-3 bg-muted/30 rounded-lg space-y-2 mt-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {st.peserta.map((p, idx) => (
                      <div key={idx} className="flex flex-col text-[10px] bg-background border border-border px-2 py-1 rounded">
                        <span className="text-foreground font-bold">{p.nama}</span>
                        <span className="text-muted-foreground text-[9px]">{p.jabatan}</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      >
        {!loading && suratTugasList.length > 0 && (
          <Table>
            <TableHeader>
              <TableRow>
